...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/product.css">
...
<div id="container">
  ...
  <div class="title">
    <h3><?php the_field('faq_sub_title');?></h3>
  </div>
  <ul class="faq">
   <?php
if( have_rows('faq_list') ):
    while( have_rows('faq_list') ) : the_row();?>
    <li class="q"><i class="ion-chevron-right"></i><?php the_sub_field('title');?></li>
    <li class="a"><?php the_sub_field('description');?></li>
